...
return [
     ...
     */
    'Security' => [
        'salt' => env('SECURITY_SALT', '__SALT__12345678901234567890123456789012__SALT__'),
    ],
    ...
    'Datasources' => [
        ...
        'default' => [
            ...
            'driver' => Sqlite::class,
            'database' => ROOT . DS . 'tmp' . DS . 'chuck_jokes.sqlite',
            'encoding' => 'utf8',
            'timezone' => 'UTC',
            'cacheMetadata' => false,
        ...
        'test' => [
            'className' => Connection::class,
            'driver' => Sqlite::class,
            'database' => ROOT . DS . 'tmp' . DS . 'test_chuck_jokes.sqlite',
            'encoding' => 'utf8',
            'timezone' => 'UTC',
            'cacheMetadata' => true,
            'quoteIdentifiers' => false,
